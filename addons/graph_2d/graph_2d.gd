...
const _Graph2DAxis = preload("res://NotesAPP/addons/graph_2d/custom_nodes/axis.gd")
const _Graph2DCoord = preload("res://NotesAPP/addons/graph_2d/custom_nodes/coordinate.gd")
const _Graph2DGrid = preload("res://NotesAPP/addons/graph_2d/custom_nodes/grid.gd")
const _Graph2DLegend = preload("res://NotesAPP/addons/graph_2d/custom_nodes/legend.gd")
